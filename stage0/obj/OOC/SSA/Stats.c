...
static OOC_SSA_Stats__Stats OOC_SSA_Stats__NewStats() {
  ...
  i1=0;
l1_loop:
  *(OOC_INT32*)((_check_pointer(i0, 571))+(_check_index(i1, 1044, OOC_UINT32, 577))*4) = 0;
  i1 = i1+1;
  i = i1;
  i2 = i1<=1043;
  if (i2) goto l1_loop;
...
l4:
  i1 = (OOC_INT32)pb;
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 979))+8);
...
l7_loop:
  ...
  i2 = (i2*12)+i3;
  i = i2;
  i3 = *(OOC_INT32*)((_check_pointer(i0, 1098))+(_check_index(i2, 1044, OOC_UINT32, 1104))*4);
  *(OOC_INT32*)((_check_pointer(i0, 1098))+(_check_index(i2, 1044, OOC_UINT32, 1104))*4) = (i3+1);
...
l3_loop:
              ...
              i4 = *(OOC_INT32*)((_check_pointer(i4, 1937))+(_check_index(i2, 1044, OOC_UINT32, 1943))*4);
              i5 = *(OOC_INT32*)((_check_pointer(i5, 1958))+(_check_index(i3, 1044, OOC_UINT32, 1964))*4);
              i4 = i4>i5;
              if (i4) goto l10;
              ...
              i4 = *(OOC_INT32*)((_check_pointer(i4, 2029))+(_check_index(i2, 1044, OOC_UINT32, 2035))*4);
              i5 = *(OOC_INT32*)((_check_pointer(i5, 2050))+(_check_index(i3, 1044, OOC_UINT32, 2056))*4);
              i4 = i4<i5;
              if (i4) goto l8;
              i1 = i1-1;
              j = i1;
...
l3_loop:
              ...
              i4 = *(OOC_INT32*)((_check_pointer(i4, 2371))+(_check_index(i2, 1044, OOC_UINT32, 2377))*4);
              i4 = i4!=0;
              if (!i4) goto l6;
              return 0u;
l6:
...
l19:
      ...
      i0=0;
l1_loop:
      *(OOC_INT32*)((OOC_INT32)o+(_check_index(i0, 1044, OOC_UINT32, 3007))*4) = i0;
      i0 = i0+1;
      i1 = i0<=1043;
      if (i1) goto l1_loop;
l5:
...
l24:
  ...
  i0=0;
l25_loop:
  i0 = *(OOC_INT32*)((OOC_INT32)o+(_check_index(i0, 1044, OOC_UINT32, 4216))*4);
  j = i0;
  i1 = i0>=0;
  if (!i1) goto l36;
...
l30_loop:
  ...
  i5 = *(OOC_INT32*)((_check_pointer(i5, 4514))+(_check_index(i2, 1044, OOC_UINT32, 4520))*4);
  Out__LongInt(i5, 10);
  ...
  i8 = *(OOC_INT32*)((_check_pointer(i9, 4570))+(_check_index(i2, 1044, OOC_UINT32, 4576))*4);
