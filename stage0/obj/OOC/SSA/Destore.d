...
RT0__StructDesc _td_OOC_SSA_Destore__State = { (RT0__Struct[]){&_td_OOC_SSA_Destore__StateDesc}, NULL, NULL, &_mid, "State", 4, -1, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA_Destore__StateDesc = { (RT0__Struct[]){&_td_OOC_SSA_Destore__StateDesc}, (void*[]){(void*)OOC_SSA_Destore__StateDesc_ClobberedBy,(void*)OOC_SSA_Destore__StateDesc_Transform}, NULL, &_mid, "StateDesc", 8, 0, RT0__strRecord };
RT0__StructDesc _td_OOC_SSA_Destore__CacheEntry = { (RT0__Struct[]){&_td_OOC_SSA_Destore__CacheEntryDesc}, NULL, NULL, &_mid, "CacheEntry", 4, -1, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA_Destore__CacheEntryDesc = { (RT0__Struct[]){&_td_Object__ObjectDesc,&_td_OOC_SSA__NodeDesc,&_td_OOC_SSA_Destore__CacheEntryDesc}, (void*[]){(void*)Object__ObjectDesc_Equals,(void*)Object__ObjectDesc_HashCode,(void*)Object__ObjectDesc_ToString}, NULL, &_mid, "CacheEntryDesc", 12, 2, RT0__strRecord };
RT0__StructDesc _td_OOC_SSA_Destore__Worklist = { (RT0__Struct[]){&_td_OOC_SSA_Destore__WorklistDesc}, NULL, NULL, &_mid, "Worklist", 4, -1, RT0__strPointer };
RT0__StructDesc _td_OOC_SSA_Destore__WorklistDesc = { (RT0__Struct[]){&_td_OOC_SSA_Destore__WorklistDesc}, (void*[]){}, NULL, &_mid, "WorklistDesc", 8, 0, RT0__strRecord };
RT0__StructDesc _td_OOC_SSA_Destore__8825 = { (RT0__Struct[]){&RT0__char}, NULL, NULL, &_mid, NULL, 1, 1, RT0__strOpenArray };
