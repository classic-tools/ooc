...
void OOC_Auxiliary_WriteSymbolFile__WriteSymbolFile(OOC_Repository__Module m, OOC_SymbolTable__Module symTab, OOC_Error__List errList) {
  ...
  i2 = (OOC_INT32)m;
  i2 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 704)))), OOC_Repository__ModuleDesc_GetOutputChannel)),OOC_Repository__ModuleDesc_GetOutputChannel)((OOC_Repository__Module)i2, 1, OOC_TRUE);
  ...
  i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 1211)), (OOC_INT32)0);
  ...
  i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 1258)), (OOC_INT32)0);
  i4 = i4-1;
  i5 = 0<=i4;
  i = 0;
  if (!i5) goto l8;
...
l3_loop:
  ...
  i8 = OOC_ARRAY_LENGTH((_check_pointer(i8, 1338)), (OOC_INT32)0);
