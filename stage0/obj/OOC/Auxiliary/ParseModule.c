...
l6:
  ...
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 2457)))), OOC_Scanner_InputBuffer__BufferDesc_Close)),OOC_Scanner_InputBuffer__BufferDesc_Close)((OOC_Scanner_InputBuffer__Buffer)i1);
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 2503))+4);
  *pragmaHistory = (OOC_Config_Pragmas__History)i1;
  *ast = (OOC_AST__Node)(OOC_INT32)0;
  i1 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 2561)))), OOC_Error__ListDesc_NoErrors)),OOC_Error__ListDesc_NoErrors)((OOC_Error__List)i2);
  if (i1) goto l9;
  i1=(OOC_INT32)0;
  goto l17;
l9:
...
l16:
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 2945))+8);
...
l17:
  *symTab = (OOC_SymbolTable__Module)(OOC_INT32)0;
  i3 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 3068)))), OOC_Error__ListDesc_NoErrors)),OOC_Error__ListDesc_NoErrors)((OOC_Error__List)i2);
  if (!i3) goto l35;
  ...
  *symTab = (OOC_SymbolTable__Module)i1;
  i3 = createNamespace;
  if (!i3) goto l35;
  i3 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 3324)))), OOC_Error__ListDesc_NoErrors)),OOC_Error__ListDesc_NoErrors)((OOC_Error__List)i2);
  if (!i3) goto l24;
...
l34:
  ...
  *errList = (OOC_Error__List)i0;
  i1 = (OOC_INT32)res;
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 2106)))), OOC_Error__ListDesc_Append)),OOC_Error__ListDesc_Append)((OOC_Error__List)i0, (Msg__Msg)i1);
l35:
  return;
  ;
}
