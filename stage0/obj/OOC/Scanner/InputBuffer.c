...
OOC_CHAR8 OOC_Scanner_InputBuffer__BufferDesc_NextBlock(OOC_Scanner_InputBuffer__Buffer b) {
  ...
  _assert((i1==(OOC_CHAR8)'\000'), 127, 3694);
  ...
  _assert((i1==(OOC_CHAR8)'\000'), 127, 3745);
...
l6:
  ...
  _assert((i1==(OOC_CHAR8)'\000'), 127, 4456);
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 4553))+4);
  i2 = *(OOC_INT32*)((_check_pointer(i0, 4517))+12);
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 4560)), (OOC_INT32)0);
  i1 = (i2+4096)>=i1;
  if (!i1) goto l14;
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 4680))+4);
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 4687)), (OOC_INT32)0);
...
l14:
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 5087)), (OOC_INT32)0);
  i1 = (((i1-i2)-1)>>12)*4096;
  len = i1;
  ...
  *(OOC_INT32*)((_check_pointer(i0, 5328))+12) = (i2+i1);
  ...
  i3 = OOC_ARRAY_LENGTH(i1, (OOC_INT32)0);
  *(OOC_UINT8*)(i1+(_check_index(i2, i3, OOC_UINT32, 5361))) = (OOC_CHAR8)'\000';
  ...
  _assert((i0==(OOC_CHAR8)'\000'), 127, 5398);
  return OOC_TRUE;
  goto l18;
l17:
  ...
  _assert((i0==(OOC_CHAR8)'\000'), 127, 5241);
  return OOC_FALSE;
l18:
...
OOC_CHAR8 OOC_Scanner_InputBuffer__BufferDesc_EndOfBuffer(OOC_Scanner_InputBuffer__Buffer b, OOC_INT32 cpos) {
  ...
  _assert((i2==(OOC_CHAR8)'\000'), 127, 5874);
...
void OOC_Scanner_InputBuffer__BufferDesc_Close(OOC_Scanner_InputBuffer__Buffer b) {
  ...
  *(OOC_INT32*)(_check_pointer(i0, 6229)) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i0, 6246))+4) = (OOC_INT32)0;
  return;
  ;
}
...
OOC_Scanner_InputBuffer__Buffer OOC_Scanner_InputBuffer__New(IO__ByteChannel ch, OOC_Error__List errList) {
  ...
  *(OOC_INT32*)((_check_pointer(i0, 6747))+4) = ((OOC_INT32)RT0__NewObject(_td_OOC_Scanner_InputBuffer__CharArray.baseTypes[0], 16352));
  ...
  i2 = OOC_ARRAY_LENGTH(i1, (OOC_INT32)0);
  *(OOC_UINT8*)(i1+(_check_index(0, i2, OOC_UINT8, 6783))) = (OOC_CHAR8)'\000';
