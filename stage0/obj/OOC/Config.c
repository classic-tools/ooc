...
static void OOC_Config__InitConfig(const OOC_CHAR8 defaultConfigFile__ref[], OOC_LEN defaultConfigFile_0d) {
  ...
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 1763)))), Config_Source_CmdLine__CmdLineDesc_AddOptionTemplate)),Config_Source_CmdLine__CmdLineDesc_AddOptionTemplate)((Config_Source_CmdLine__CmdLine)i1, "--config", 9, "<option><set name=\047config-file\047>$1</set></option>", 50);
  ...
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 1894))+12);
  i1 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 1903)))), Config_Source_Environment__EnvironmentDesc_AddVariableTemplate)),Config_Source_Environment__EnvironmentDesc_AddVariableTemplate)((Config_Source_Environment__Environment)i2, "OO2CRC", 7, "<option><set name=\047config-file\047>$1</set></option>", 50);
  ...
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 2048))+32);
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 2048))+32);
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 2061)))), Config_Section__SectionListDesc_Add)),Config_Section__SectionListDesc_Add)((Config_Section__SectionList)i1, (Config_Section__Section)i0);
  ...
  i1 = (OOC_INT32)OOC_Config__config;
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 2170))+32);
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 2170))+32);
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 2183)))), Config_Section__SectionListDesc_Add)),Config_Section__SectionListDesc_Add)((Config_Section__SectionList)i1, (Config_Section__Section)i0);
