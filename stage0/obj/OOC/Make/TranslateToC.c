...
void OOC_Make_TranslateToC__InitTranslator(OOC_Make_TranslateToC__Translator t) {
  ...
  i0 = (OOC_INT32)t;
  *(OOC_INT32*)(_check_pointer(i0, 2154)) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i0, 2171))+4) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i0, 2189))+8) = (OOC_INT32)0;
...
void OOC_Make_TranslateToC__TranslatorDesc_WriteNestedProcedures(OOC_Make_TranslateToC__Translator t) {
  ...
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 4020)), (OOC_INT32)0);
  i3 = i2!=i3;
  if (!i3) goto l14;
l5_loop:
...
l3_loop:
  ...
  i1 = i1==(OOC_CHAR8)':';
  if (!i1) goto l6;
  *(OOC_UINT8*)((OOC_INT32)str+(_check_index(i0, 1024, OOC_UINT32, 4640))) = (OOC_CHAR8)'_';
l6:
  i0 = i0+1;
  i = i0;
...
static void OOC_Make_TranslateToC__WriteCodeFile(OOC_C_DeclWriter__Writer w, OOC_C_DeclWriter__Writer wd, OOC_Repository__Module m, OOC_IR__Module moduleIR, OOC_Make_TranslateToC__Translator translator) {
  ...
  i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 6816)), (OOC_INT32)0);
  i4 = i4-1;
  i5 = 0<=i4;
  i = 0;
  if (!i5) goto l11;
...
OOC_Error__List OOC_Make_TranslateToC__Run(OOC_Repository__Module m, Object__String libraryName, OOC_CHAR8 writeAST, OOC_CHAR8 writeIR, OOC_Make_TranslateToC__Translator translator) {
  ...
  auto void OOC_Make_TranslateToC__Run_CloseFile(OOC_C_DeclWriter__Writer w);
    ...
    OOC_C_DeclWriter__Writer OOC_Make_TranslateToC__Run_WriteFile(OOC_INT8 fileId) {
      ...
      i0 = (OOC_INT32)m;
      i1 = fileId;
      i0 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 7840)))), OOC_Repository__ModuleDesc_GetOutputChannel)),OOC_Repository__ModuleDesc_GetOutputChannel)((OOC_Repository__Module)i0, i1, OOC_TRUE);
      ch = (IO__ByteChannel)i0;
      i2 = (OOC_INT32)m;
      i2 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 7913)))), OOC_Repository__ModuleDesc_GetURI)),OOC_Repository__ModuleDesc_GetURI)((OOC_Repository__Module)i2, i1, OOC_FALSE);
