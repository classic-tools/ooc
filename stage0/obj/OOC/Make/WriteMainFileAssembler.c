...
l3_loop:
      ...
      i3 = (OOC_INT32)*(OOC_INT32*)((OOC_INT32)imports+(_check_index(i1, imports_0d, OOC_UINT32, 1930))*4);
      i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 1933))+12);
      i2 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 1940)))), OOC_SymbolTable__ModuleDesc_NoObjectFile)),OOC_SymbolTable__ModuleDesc_NoObjectFile)((OOC_SymbolTable__Module)i3);
      i2 = !i2;
      if (!i2) goto l6;
