...
l3_loop:
      ...
      i1 = i1==(OOC_CHAR8)':';
      if (!i1) goto l6;
      *(OOC_UINT8*)((OOC_INT32)str+(_check_index(i0, 1024, OOC_UINT32, 1579))) = (OOC_CHAR8)'_';
l6:
      i0 = i0+1;
      i = i0;
...
l11:
    ...
    void OOC_Make_WriteMainFileAssembler__WriteFile_WriteModules(IO_TextRider__Writer w, const OOC_CHAR8 prefix__ref[], OOC_LEN prefix_0d, const OOC_CHAR8 suffix__ref[], OOC_LEN suffix_0d) {
      ...
      i2=0;
l3_loop:
      i3 = (OOC_INT32)*(OOC_INT32*)((OOC_INT32)imports+(_check_index(i2, imports_0d, OOC_UINT32, 1930))*4);
      i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 1933))+12);
      i4 = (OOC_INT32)*(OOC_INT32*)((OOC_INT32)imports+(_check_index(i2, imports_0d, OOC_UINT32, 1930))*4);
      i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 1933))+12);
      i3 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i3, 1940)))), OOC_SymbolTable__ModuleDesc_NoObjectFile)),OOC_SymbolTable__ModuleDesc_NoObjectFile)((OOC_SymbolTable__Module)i4);
      i3 = !i3;
      if (!i3) goto l6;
      i3 = (OOC_INT32)*(OOC_INT32*)((OOC_INT32)imports+(_check_index(i2, imports_0d, OOC_UINT32, 2006))*4);
      OOC_Make_WriteMainFileAssembler__WriteFile_WriteModuleName((IO_TextRider__Writer)i1, (void*)(OOC_INT32)prefix, prefix_0d, (OOC_Repository__Module)i3, (void*)(OOC_INT32)suffix, suffix_0d);
l6:
      i2 = i2+1;
      i3 = i2<=i0;
      i = i2;
...
l11:
    ...
    void OOC_Make_WriteMainFileAssembler__WriteFile_Instr(const OOC_CHAR8 instr__ref[], OOC_LEN instr_0d) {
      ...
      i0 = (OOC_INT32)w;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 2246)))), IO_TextRider__WriterDesc_WriteChar)),IO_TextRider__WriterDesc_WriteChar)((IO_TextRider__Writer)i0, (OOC_CHAR8)'\011');
      i0 = (OOC_INT32)w;
  ...
  i0 = (OOC_INT32)module;
  i0 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 2360)))), OOC_Repository__ModuleDesc_GetOutputChannel)),OOC_Repository__ModuleDesc_GetOutputChannel)((OOC_Repository__Module)i0, 16, OOC_TRUE);
