...
void OOC_Make_TranslateToIA32__InitTranslator(OOC_Make_TranslateToIA32__Translator t, OOC_Repository__Module module) {
  ...
  i0 = (OOC_INT32)t;
  *(OOC_INT32*)(_check_pointer(i0, 1922)) = 0;
  *(OOC_INT32*)((_check_pointer(i0, 1939))+12) = 0;
  *(OOC_INT32*)((_check_pointer(i0, 1963))+16) = (-1);
  i1 = (OOC_INT32)module;
  *(OOC_INT32*)((_check_pointer(i0, 1989))+4) = i1;
  *(OOC_INT32*)((_check_pointer(i0, 2014))+8) = 0;
  return;
  ;
}
...
void OOC_Make_TranslateToIA32__TranslatorDesc_WriteNestedProcedures(OOC_Make_TranslateToIA32__Translator t) {
  ...
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 3405)), 0);
  i3 = i2!=i3;
  if (!i3) goto l14;
l5_loop:
...
static void OOC_Make_TranslateToIA32__WriteCodeFile(OOC_IA32_Writer__Writer w, OOC_Repository__Module m, OOC_SymbolTable__Module symTab, OOC_IR__Module moduleIR, OOC_Make_TranslateToIA32__Translator translator) {
  ...
  i = 0;
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 4064)), 0);
  i4 = 0<i3;
  if (!i4) goto l11;
  i4=0;
l3_loop:
...
OOC_Error__List OOC_Make_TranslateToIA32__Run(OOC_Repository__Module m, Object__String libraryName, OOC_CHAR8 writeAST, OOC_CHAR8 writeIR, OOC_Make_TranslateToIA32__Translator translator) {
  ...
  auto void OOC_Make_TranslateToIA32__Run_CloseFile(OOC_IA32_Writer__Writer w);
    ...
    void OOC_Make_TranslateToIA32__Run_CloseFile(OOC_IA32_Writer__Writer w) {
      ...
      i1 = i0!=(OOC_INT32)0;
      if (!i1) goto l4;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 4956)))), OOC_IA32_Writer__WriterDesc_Newline)),OOC_IA32_Writer__WriterDesc_Newline)((OOC_IA32_Writer__Writer)i0);
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 4976)))), OOC_IA32_Writer__WriterDesc_Close)),OOC_IA32_Writer__WriterDesc_Close)((OOC_IA32_Writer__Writer)i0);
l4:
      return;
      ;
    }
  ...
  i1 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 5406)))), OOC_Error__ListDesc_NoErrors)),OOC_Error__ListDesc_NoErrors)((OOC_Error__List)i1);
  if (!i1) goto l12;
  i1 = writeAST;
  if (!i1) goto l5;
  i1 = (OOC_INT32)ast;
  i2 = (OOC_INT32)IO_StdChannels__stdout;
  OOC_AST_ExtTree_XML__Write((IO__ByteChannel)i2, (OOC_AST_ExtTree__Module)(_type_guard(i1, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 5502)))), &_td_OOC_AST_ExtTree__ModuleDesc, 5502)));
l5:
  i1 = (OOC_INT32)ast;
  i2 = (OOC_INT32)symTab;
  ...
  i1 = (OOC_INT32)OOC_AST_ExtTree_CreateIR__CreateIR((OOC_AST_ExtTree__Module)(_type_guard(i1, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 5572)))), &_td_OOC_AST_ExtTree__ModuleDesc, 5572)), (OOC_SymbolTable__Module)i2, (OOC_IR__Builder)i3);
...
l8:
  ...
  i2 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 5975)))), OOC_Error__ListDesc_NoErrors)),OOC_Error__ListDesc_NoErrors)((OOC_Error__List)i2);
  if (!i2) goto l12;
  i2 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 6117)))), OOC_Repository__ModuleDesc_GetOutputChannel)),OOC_Repository__ModuleDesc_GetOutputChannel)((OOC_Repository__Module)i0, 14, 1u);
