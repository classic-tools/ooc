...
void OOC_IA32_RuntimeData__Write(OOC_IA32_Writer__Writer w, OOC_SymbolTable__Module symTab) {
  ...
  auto void OOC_IA32_RuntimeData__Write_ModuleDescr(OOC_SymbolTable__Module module);
    ...
    void OOC_IA32_RuntimeData__Write_ModuleDescr(OOC_SymbolTable__Module module) {
      ...
      i0 = (OOC_INT32)w;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 1231)))), OOC_IA32_Writer__WriterDesc_Label)),OOC_IA32_Writer__WriterDesc_Label)((OOC_IA32_Writer__Writer)i0, "_mid", 5);
      i0 = (OOC_INT32)w;
      ...
      i0 = (OOC_INT32)w;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 1326)))), OOC_IA32_Writer__WriterDesc_Label)),OOC_IA32_Writer__WriterDesc_Label)((OOC_IA32_Writer__Writer)i0, ".LC0", 5);
      i0 = (OOC_INT32)w;
      i1 = (OOC_INT32)symTab;
