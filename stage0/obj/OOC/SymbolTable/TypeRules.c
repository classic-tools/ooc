...
l13:
  ...
  i1 = (
  _cmp8((const void*)(_check_pointer(i1, 3196)),(const void*)(OOC_INT32)recordName))==(OOC_INT32)0;
...
l21:
  ...
  i1 = (
  _cmp8((const void*)(_check_pointer(i1, 3323)),(const void*)(OOC_INT32)module))==(OOC_INT32)0;
...
l5:
  ...
  i0 = (OOC_INT32)base;
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i0, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 12612)))), &_td_OOC_SymbolTable__PointerDesc, 12612)), 12620))+32);
...
l12:
  ...
  goto l18;
l16:
  i0 = OOC_TYPE_TEST(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 12839)))), &_td_OOC_SymbolTable__RecordDesc);
...
l20_loop:
  ...
  if (i2) goto l23;
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i1, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 12958)))), &_td_OOC_SymbolTable__RecordDesc, 12958)), 12965))+32);
...
l24:
  ...
  goto l29;
l27:
  i1 = OOC_TYPE_TEST(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 12839)))), &_td_OOC_SymbolTable__RecordDesc);
...
OOC_CHAR8 OOC_SymbolTable_TypeRules__FormalParamsMatch(OOC_SymbolTable__FormalPars baseFPars, OOC_SymbolTable__FormalPars procFPars, OOC_CHAR8 allowSpecialization) {
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 14253)), (OOC_INT32)0);
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 14280)), (OOC_INT32)0);
  i1 = i1!=i3;
  if (i1) goto l142;
...
l27:
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 14967)), (OOC_INT32)0);
  i1 = i1-1;
  i3 = 0<=i1;
  i = 0;
  if (!i3) goto l45;
...
l45:
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 15933)), (OOC_INT32)0);
  i1 = i1-1;
  i3 = 0<=i1;
  i = 0;
  if (!i3) goto l75;
...
l50_loop:
  ...
  i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 16000)), (OOC_INT32)0);
  i4 = 0!=i4;
  if (i4) goto l53;
  i4=OOC_FALSE;
  goto l55;
...
l58_loop:
  ...
  i5 = OOC_ARRAY_LENGTH((_check_pointer(i5, 16000)), (OOC_INT32)0);
  i5 = i4!=i5;
  if (i5) goto l61;
  i5=OOC_FALSE;
  goto l63;
...
l67:
  ...
  i5 = OOC_ARRAY_LENGTH((_check_pointer(i5, 16186)), (OOC_INT32)0);
  i4 = i4==i5;
  if (!i4) goto l70;
  return OOC_FALSE;
l70:
...
l75:
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 16306)), (OOC_INT32)0);
  i1 = i1-1;
  i3 = 0<=i1;
  i = 0;
  if (!i3) goto l133;
...
l78_loop:
  ...
  i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 16373)), (OOC_INT32)0);
  i4 = 0!=i4;
  if (i4) goto l81;
  i4=OOC_FALSE;
  goto l83;
...
l86_loop:
  ...
  i5 = OOC_ARRAY_LENGTH((_check_pointer(i5, 16373)), (OOC_INT32)0);
  i5 = i4!=i5;
  if (i5) goto l89;
  i5=OOC_FALSE;
  goto l91;
...
l95:
  ...
  i5 = OOC_ARRAY_LENGTH((_check_pointer(i5, 16559)), (OOC_INT32)0);
  i4 = i4==i5;
  if (!i4) goto l98;
  return OOC_FALSE;
l98:
...
l104:
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 15309)), (OOC_INT32)0);
  i1 = i1-1;
  i3 = 0<=i1;
  i = 0;
  if (!i3) goto l133;
...
l107_loop:
  ...
  i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 15376)), (OOC_INT32)0);
  i4 = 0!=i4;
  if (i4) goto l110;
  i4=OOC_FALSE;
  goto l112;
...
l115_loop:
  ...
  i5 = OOC_ARRAY_LENGTH((_check_pointer(i5, 15376)), (OOC_INT32)0);
  i5 = i4!=i5;
  if (i5) goto l118;
  i5=OOC_FALSE;
  goto l120;
...
l124:
  ...
  i5 = OOC_ARRAY_LENGTH((_check_pointer(i5, 15572)), (OOC_INT32)0);
  i4 = i4==i5;
  if (!i4) goto l127;
  return OOC_FALSE;
l127:
...
l3:
  ...
  i0 = OOC_TYPE_TEST(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 18195)))), &_td_OOC_SymbolTable__ArrayDesc);
  
l5:
  if (!i0) goto l16;
l7_loop:
  i0 = (OOC_INT32)argType;
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i0, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 18241)))), &_td_OOC_SymbolTable__ArrayDesc, 18241)), 18247))+36);
  argType = (OOC_SymbolTable__Type)i0;
  i1 = (OOC_INT32)fparType;
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i1, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 18293)))), &_td_OOC_SymbolTable__ArrayDesc, 18293)), 18299))+36);
...
l63:
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 23092)), (OOC_INT32)0);
  i1 = i1-1;
  i2 = 0<=i1;
  i = 0;
  if (!i2) goto l75;
