...
l4_loop:
  ...
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i5, 4873))+16);
...
l16:
  ...
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 5034))+16);
...
l20:
  ...
  i1 = i1==i2;
  if (i1) goto l27;
  i1 = *(OOC_INT8*)((_check_pointer(i0, 5384))+24);
  i1 = i1==0;
  if (!i1) goto l36;
  *baseNotExported = 1u;
  i0=0;
...
l27:
  i1 = (OOC_INT32)name;
  i2 = *(OOC_INT32*)((_check_pointer(i0, 5283))+20);
...
static void OOC_SymbolTable_Namespace__ErrDecl(OOC_INT32 code, OOC_SymbolTable__Declaration decl, OOC_Error__List errList) {
  ...
  i1 = (OOC_INT32)decl;
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 6255))+16);
  ...
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 6310))+16);
  ...
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 6368))+16);
...
l3_loop:
  ...
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 7001))+16);
  ...
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i5, 7023))+16);
...
l8:
  ...
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i4, 7291))+16);
  ...
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i5, 7311))+16);
...
l13_loop:
  ...
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i6, 7347))+16);
  i8 = _check_pointer(i1, 7363);
  i9 = OOC_ARRAY_LENGTH(i8, 0);
  i8 = (OOC_INT32)*(OOC_INT32*)(i8+(_check_index(i5, i9, OOC_UINT32, 7363))*4);
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i8, 7368))+16);
...
l20:
  ...
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i6, 7291))+16);
  ...
  i8 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i8, 7311))+16);
...
void OOC_SymbolTable_Namespace__ExtendedDesc_InsertTBProc(OOC_SymbolTable_Namespace__Extended ns, OOC_SymbolTable__ProcDecl procDecl, OOC_Error__List errList) {
  ...
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 11637))+16);
...
l6_loop:
  ...
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i5, 11842))+16);
  i5 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i5, 11848))+12);
  i6 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 11865))+16);
...
l15:
  ...
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 12052))+16);
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 12058))+12);
  i4 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 12075))+16);
...
l3_loop:
  ...
  if (!i5) goto l9;
  i5 = *(OOC_INT32*)((_check_pointer(i4, 12840))+52);
  i5 = i5==i2;
  if (!i5) goto l9;
...
l8:
  ...
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 15103))+16);
...
l15:
  ...
  goto l89;
l20:
  i9 = *(OOC_INT8*)((_check_pointer(i7, 15311))+24);
  i10 = *(OOC_INT8*)((_check_pointer(i8, 15330))+24);
  i9 = i9!=i10;
  if (!i9) goto l23;
...
l23:
  ...
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i9, 15478))+24);
  i10 = i10!=0;
  if (i10) goto l26;
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i8, 16246))+60);
  baseFormalPars = (OOC_SymbolTable__Type)i9;
  
  goto l44;
l26:
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i9, 15648))+24);
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i10, 15657))+16);
...
l29_loop:
  ...
  i15 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i9, 15757))+24);
  i15 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i15, 15766))+16);
...
l34:
  ...
  i12 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i9, 15891))+16);
...
l38_loop:
  ...
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer((_type_guard(i10, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i10, 16093)))), &_td_OOC_SymbolTable__RecordDesc, 16093)), 16100))+36);
...
l43:
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i8, 16179))+60);
...
l44:
  i10 = *(OOC_INT8*)((_check_pointer(i7, 16309))+44);
  i10 = i10==2;
  if (i10) goto l47;
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 16401))+60);
...
l49:
  ...
  goto l89;
l51:
  i9 = *(OOC_UINT8*)((_check_pointer(i8, 16440))+47);
  if (!i9) goto l54;
  *(OOC_UINT8*)((_check_pointer(i8, 16479))+47) = 0u;
l54:
  OOC_SymbolTable__ProcDeclDesc_CopyTBProcIndex((OOC_SymbolTable__ProcDecl)i8, (OOC_SymbolTable__ProcDecl)i7);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 16588))+16);
  i10 = *(OOC_INT32*)((_check_pointer(i8, 16606))+20);
...
l57:
  i9 = *(OOC_INT8*)((_check_pointer(i7, 16731))+44);
  i9 = i9==2;
  if (!i9) goto l70;
  i9 = *(OOC_INT8*)((_check_pointer(i7, 16791))+24);
  i9 = i9==0;
  if (!i9) goto l62;
  OOC_SymbolTable_Namespace__ErrDecl(8, (OOC_SymbolTable__Declaration)i7, (OOC_Error__List)i2);
l62:
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 16944))+16);
  ...
  goto l67;
l65:
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 17002))+60);
  i9 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i9, 17013))+40);
  i9 = i9!=0;
...
l70:
  ...
  i10 = *(OOC_UINT8*)((_check_pointer(i7, 17171))+32);
  if (i10) goto l73;
  i10 = *(OOC_UINT8*)((_check_pointer(i8, 17190))+32);
...
l74:
  *(OOC_UINT8*)(i9+32) = i10;
  i7 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 17258))+16);
...
l81:
  ...
  i10 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i7, 14691))+16);
...
l86:
  i8 = baseNotExported;
  *(OOC_UINT8*)((_check_pointer(i7, 14769))+56) = i8;
l89:
  i6 = i6+1;
  i = i6;
  i7 = i6<i1;
