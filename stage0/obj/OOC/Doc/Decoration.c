...
l5:
      ...
      i2=1;
l7_loop:
      i3 = _check_pointer(i0, 3353);
      i5 = OOC_ARRAY_LENGTH(i3, 0);
      *(OOC_UINT8*)(i3+(_check_index(i2, i5, OOC_UINT32, 3353))) = 32u;
      i2 = i2+1;
      i = i2;
      i3 = _check_pointer(i0, 3314);
      i5 = OOC_ARRAY_LENGTH(i3, 0);
      i3 = *(OOC_UINT8*)(i3+(_check_index(i2, i5, OOC_UINT32, 3314)));
      i3 = i3==42u;
      if (i3) goto l10;
      i3=0u;
      goto l12;
...
l16:
      ...
      i3 = OOC_ARRAY_LENGTH(i2, 0);
      i5 = i1-1;
      i2 = *(OOC_UINT8*)(i2+(_check_index(i5, i3, OOC_UINT32, 3416)));
      _assert((i2==41u), 127, 3405);
      i2 = _check_pointer(i0, 3441);
      i3 = OOC_ARRAY_LENGTH(i2, 0);
      *(OOC_UINT8*)(i2+(_check_index(i5, i3, OOC_UINT32, 3441))) = 32u;
      i2 = _check_pointer(i0, 3474);
      i3 = OOC_ARRAY_LENGTH(i2, 0);
      i2 = *(OOC_UINT8*)(i2+(_check_index(i4, i3, OOC_UINT32, 3474)));
      _assert((i2==42u), 127, 3463);
      i = i4;
      i2 = _check_pointer(i0, 3539);
      i3 = OOC_ARRAY_LENGTH(i2, 0);
      i2 = *(OOC_UINT8*)(i2+(_check_index(i4, i3, OOC_UINT32, 3539)));
      i2 = i2==42u;
      if (!i2) goto l24;
      i2=i4;
l19_loop:
      ...
      *(OOC_UINT8*)(i3+(_check_index(i2, i4, OOC_UINT32, 3564))) = 32u;
      i2 = i2-1;
      i = i2;
...
l24:
      ...
      *(OOC_INT32*)((_check_pointer(i2, 3831))+4) = 79;
      ...
      i4=0;
l27_loop:
      i5 = _check_pointer(i0, 3895);
      i6 = OOC_ARRAY_LENGTH(i5, 0);
      i5 = *(OOC_UINT8*)(i5+(_check_index(i4, i6, OOC_UINT32, 3895)));
      i4 = i4+1;
      i5 = i5==10u;
      if (!i5) goto l33;
      i5 = OOC_ARRAY_LENGTH((_check_pointer(i0, 3955)), 0);
      i5 = OOC_Doc_Decoration__Remove_GetIndent((void*)(_check_pointer(i0, 3955)), i5, i4, 0);
      indent = i5;
      i6 = *(OOC_INT32*)(_check_pointer(i2, 4001));
      i6 = i5<i6;
      if (!i6) goto l33;
      *(OOC_INT32*)(_check_pointer(i2, 4039)) = i5;
l33:
      i = i4;
      i5 = i4<i1;
      if (i5) goto l27_loop;
...
l46_loop:
      ...
      i4 = *(OOC_UINT8*)(i4+(_check_index(i3, i5, OOC_UINT32, 4483)));
      i4 = i4==10u;
...
l63:
      if (i5) goto l65;
      i5 = _check_pointer(i0, 4696);
      i6 = OOC_ARRAY_LENGTH(i5, 0);
      i5 = *(OOC_UINT8*)(i5+(_check_index(i3, i6, OOC_UINT32, 4696)));
      i5 = i5==10u;
...
l67:
      if (i5) goto l77;
      i5 = _check_pointer(i0, 4786);
      i6 = OOC_ARRAY_LENGTH(i5, 0);
      i5 = *(OOC_UINT8*)(i5+(_check_index(i3, i6, OOC_UINT32, 4786)));
      switch (i5) {
      case 32u:
        i5 = _check_pointer(i0, 4824);
        i6 = OOC_ARRAY_LENGTH(i5, 0);
        *(OOC_UINT8*)(i5+(_check_index(i3, i6, OOC_UINT32, 4824))) = 2u;
        goto l74;
      case 9u:
        i5 = _check_pointer(i0, 4875);
        i6 = OOC_ARRAY_LENGTH(i5, 0);
        *(OOC_UINT8*)(i5+(_check_index(i3, i6, OOC_UINT32, 4875))) = 3u;
        goto l74;
      default:
        goto l74;
      }
...
l27_loop:
      ...
      i4 = OOC_ARRAY_LENGTH(i3, 0);
      *(OOC_UINT8*)(i3+(_check_index(i2, i4, OOC_UINT32, 6178))) = 32u;
      i2 = i2+1;
      i = i2;
      i3 = _check_pointer(i0, 6149);
      i4 = OOC_ARRAY_LENGTH(i3, 0);
...
l38:
  ...
  _copy_8((const void*)(_check_pointer(i0, 6609)),(void*)(_check_pointer(i1, 6615)),i2);
  i = 0;
  delta = 0;
...
l9:
  ...
  i4 = OOC_ARRAY_LENGTH(i3, 0);
  *(OOC_UINT8*)(i3+(_check_index((i0-i2), i4, OOC_UINT32, 6949))) = 10u;
l10:
...
l11:
  ...
  i4 = OOC_ARRAY_LENGTH(i3, 0);
  *(OOC_UINT8*)(i3+(_check_index((i0-i2), i4, OOC_UINT32, 6792))) = 10u;
...
OOC_Scanner_InputBuffer__CharArray OOC_Doc_Decoration__PlainIndentDesc_Decorate(OOC_Doc_Decoration__PlainIndent d, OOC_Scanner_InputBuffer__CharArray s) {
  ...
  _copy_8((const void*)(_check_pointer(i0, 7790)),(void*)(_check_pointer(i2, 7795)),i3);
  i0 = i1>0;
  if (i0) goto l3;
  i0=0u;
  goto l5;
...
l5:
  ...
  i3 = OOC_ARRAY_LENGTH(i0, 0);
  *(OOC_UINT8*)(i0+(_check_index((i1-1), i3, OOC_UINT32, 7864))) = 0u;
l7:
...
l12:
  ...
  *(OOC_UINT8*)((OOC_INT32)ins+(_check_index(2, 4, OOC_UINT8, 8101))) = 10u;
...
l14:
  ...
  i4 = OOC_ARRAY_LENGTH(i0, 0);
  *(OOC_UINT8*)(i0+(_check_index(i3, i4, OOC_UINT32, 8004))) = 40u;
  i0 = _check_pointer(i2, 8037);
  i1 = *(OOC_INT32*)((_check_pointer(i1, 8039))+8);
  i3 = OOC_ARRAY_LENGTH(i0, 0);
  *(OOC_UINT8*)(i0+(_check_index((i1+1), i3, OOC_UINT32, 8037))) = 42u;
l15:
