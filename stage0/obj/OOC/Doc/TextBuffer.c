...
static void OOC_Doc_TextBuffer__Extend(OOC_Doc_TextBuffer__Buffer b, OOC_INT32 to) {
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 1479)), (OOC_INT32)0);
  i2 = to;
  i3 = i1<=i2;
  i = i1;
  if (!i3) goto l9;
...
l9:
  ...
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i1, 1573)), (OOC_INT32)0);
...
void OOC_Doc_TextBuffer__BufferDesc_Append(OOC_Doc_TextBuffer__Buffer b, const OOC_CHAR8 str[], OOC_LEN str_0d) {
  ...
  i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 1767)), (OOC_INT32)0);
  i2 = (i3+i0)>=i2;
  if (!i2) goto l4;
...
l4:
  ...
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 1845)), (OOC_INT32)0);
...
void OOC_Doc_TextBuffer__BufferDesc_AppendEOL(OOC_Doc_TextBuffer__Buffer b) {
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 1959)), (OOC_INT32)0);
  i1 = (i2+1)>=i1;
  if (!i1) goto l4;
...
void OOC_Doc_TextBuffer__BufferDesc_AppendSpaces(OOC_Doc_TextBuffer__Buffer b, OOC_INT32 len) {
  ...
  i3 = len;
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 2219)), (OOC_INT32)0);
  i1 = (i2+i3)>=i1;
  if (!i1) goto l3;
...
void OOC_Doc_TextBuffer__BufferDesc_AppendSubstring(OOC_Doc_TextBuffer__Buffer b, const OOC_CHAR8 str[], OOC_LEN str_0d, OOC_INT32 start, OOC_INT32 end) {
  ...
  i4 = OOC_ARRAY_LENGTH((_check_pointer(i4, 2631)), (OOC_INT32)0);
  i4 = (i5+i2)>=i4;
  if (!i4) goto l3;
...
l40:
  i1 = (OOC_INT32)dest;
  i2 = (OOC_INT32)s;
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i2, 6254)), (OOC_INT32)0);
  i4 = start;
...
l40:
  i1 = (OOC_INT32)dest;
  i2 = (OOC_INT32)s;
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i2, 9321)), (OOC_INT32)0);
  i4 = start;
...
l24:
  ...
  i5 = OOC_ARRAY_LENGTH((_check_pointer(i0, 9835)), (OOC_INT32)0);
