...
void OOC_Config_FileSystem__ErrorContextDesc_GetTemplate(OOC_Config_FileSystem__ErrorContext context, Msg__Msg msg, Msg__LString templ, OOC_LEN templ_0d) {
  ...
  i0 = (OOC_INT32)msg;
  i1 = *(OOC_INT32*)((_check_pointer(i0, 1722))+8);
  switch (i1) {
  case 1:
  ...
  case 3:
    ...
    goto l6;
  default:
    _failed_case(i1, 1714);
    goto l6;
  }
l6:
  i1 = (OOC_INT32)context;
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 1994)))), XML_Error__ContextDesc_WriteTemplate)),XML_Error__ContextDesc_WriteTemplate)((XML_Error__Context)i1, (Msg__Msg)i0, (void*)(OOC_INT32)t, 128, (void*)(OOC_INT32)templ, templ_0d);
  return;
  ;
}
...
OOC_Repository__Repository OOC_Config_FileSystem__RepositoryEntryDesc_ProcessElement(OOC_Config_FileSystem__RepositoryEntry re, Config_Parser__Element node, XML_Locator__ErrorListener errorListener, OOC_Repository__Repository baseRep) {
  ...
  auto void OOC_Config_FileSystem__RepositoryEntryDesc_ProcessElement_Err(OOC_INT32 code, Config_Parser__Node xmlNode);
    ...
    void OOC_Config_FileSystem__RepositoryEntryDesc_ProcessElement_Err(OOC_INT32 code, Config_Parser__Node xmlNode) {
      ...
      i3 = code;
      i0 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 2765)))), XML_Locator__ErrorListenerDesc_Error)),XML_Locator__ErrorListenerDesc_Error)((XML_Locator__ErrorListener)i0, (XML_Error__Context)i2, i3, 0u, (void*)((_check_pointer(i1, 2815))+4));
  ...
  i0 = (OOC_INT32)node;
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 2868))+32);
  i = 0;
  i0 = *(OOC_INT32*)(_check_pointer(i0, 2878));
  i1 = 0<i0;
  if (!i1) goto l8;
  i1=0;
l3_loop:
  i2 = (OOC_INT32)node;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 2906))+32);
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i3, 2916))+4);
  i3 = _check_pointer(i3, 2922);
  i4 = OOC_ARRAY_LENGTH(i3, 0);
  i1 = (OOC_INT32)*(OOC_INT32*)(i3+(_check_index(i1, i4, OOC_UINT32, 2922))*4);
  ...
  i2 = (OOC_INT32)att;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 3028))+4);
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i2, 3028))+4);
  i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 3039)), 0);
  i2 = (OOC_INT32)Msg__GetLStringPtr((void*)(_check_pointer(i3, 3039)), i2);
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 2978)))), Msg__MsgDesc_SetLStringAttrib)),Msg__MsgDesc_SetLStringAttrib)((Msg__Msg)i1, "name", 5, (Msg__LStringPtr)i2);
  i1 = i;
  i1 = i1+1;
  i = i1;
  i2 = i1<i0;
...
l8:
  ...
  i2 = OOC_ARRAY_LENGTH((_check_pointer(i1, 3231)), 0);
  LongStrings__Short((void*)(_check_pointer(i1, 3231)), i2, 63u, (void*)(OOC_INT32)str8, 4096);
  i1 = (
  _cmp8((const void*)(OOC_INT32)str8,(const void*)""))==0;
  if (i1) goto l13;
  i1 = Strings__Length((void*)(OOC_INT32)str8, 4096);
  i1 = *(OOC_UINT8*)((OOC_INT32)str8+(_check_index((i1-1), 4096, OOC_UINT16, 3275)));
  i1 = i1!=47u;
...
l17:
  ...
  i1 = (OOC_INT32)res;
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 3594)))), Msg__MsgDesc_SetMsgAttrib)),Msg__MsgDesc_SetMsgAttrib)((Msg__Msg)i0, "uri_msg", 8, (Msg__Msg)i1);
  goto l23;
l20:
  i0 = (OOC_INT32)baseRep;
  i0 = (OOC_INT32)OOC_Repository_FileSystem__New((OOC_Repository__Repository)i0, (URI__HierarchicalURI)(_type_guard(i1, ((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 3516)))), &_td_URI__HierarchicalURIDesc, 3516)));
