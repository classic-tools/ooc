...
void OOC_Config_Repositories_FileSystem__ErrorContextDesc_GetTemplate(OOC_Config_Repositories_FileSystem__ErrorContext context, Msg__Msg msg, Msg__LString templ, OOC_LEN templ_0d) {
  ...
  case 2:
    ...
    goto l6;
  case 3:
    _copy_16(((OOC_CHAR16[]){73,110,118,97,108,105,100,32,85,82,73,46,32,32,82,101,97,115,111,110,58,32,36,123,117,114,105,95,109,115,103,125,0}),(OOC_INT32)t,128);
    goto l6;
  default:
