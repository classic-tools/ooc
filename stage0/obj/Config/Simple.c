...
void Config_Simple__Init(Config_Simple__Config config, const OOC_CHAR8 defaultConfigFile__ref[], OOC_LEN defaultConfigFile_0d) {
  ...
  *(OOC_INT32*)(_check_pointer(i0, 1104)) = i1;
  goto l4;
l3:
  *(OOC_INT32*)(_check_pointer(i0, 1066)) = (OOC_INT32)0;
l4:
  *(OOC_INT32*)((_check_pointer(i0, 1175))+4) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i0, 1209))+8) = (OOC_INT32)0;
  ...
  *(OOC_INT32*)((_check_pointer(i0, 1899))+36) = (OOC_INT32)0;
  return;
  ;
}
...
void Config_Simple__ConfigDesc_Read(Config_Simple__Config config, Msg__MsgList errList) {
  ...
  auto void Config_Simple__ConfigDesc_Read_EvaluateSource(Config_Source__Source source);
    ...
    void Config_Simple__ConfigDesc_Read_EvaluateFile(Config_Value__StringPtr fileName) {
      ...
      i1 = OOC_ARRAY_LENGTH((_check_pointer(i0, 2825)), (OOC_INT32)0);
...
l25:
  ...
  i2 = (
  _cmp8((const void*)(_check_pointer(i2, 4760)),(const void*)""))==(OOC_INT32)0;
  if (i2) goto l30;
...
l38_loop:
  ...
  i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 5497)), (OOC_INT32)0);
  i2 = i2>=1;
  if (!i2) goto l48;
  ...
  i2 = (
  _cmp8((const void*)(_check_pointer(i2, 5549)),(const void*)""))==(OOC_INT32)0;
  if (i2) goto l45;
