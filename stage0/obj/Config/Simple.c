...
void Config_Simple__ConfigDesc_Read(Config_Simple__Config config, Msg__MsgList errList) {
  ...
  auto void Config_Simple__ConfigDesc_Read_EvaluateSource(Config_Source__Source source);
    ...
    void Config_Simple__ConfigDesc_Read_EvaluateFile(Config_Value__StringPtr fileName) {
      ...
      i1 = OOC_ARRAY_LENGTH((_check_pointer(i0, 2844)), 0);
...
l25:
  ...
  i2 = (
  _cmp8((const void*)(_check_pointer(i2, 5086)),(const void*)""))==0;
  if (i2) goto l30;
...
l38_loop:
  ...
  i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 5823)), 0);
  i2 = i2>=1;
  if (!i2) goto l48;
  ...
  i2 = (
  _cmp8((const void*)(_check_pointer(i2, 5875)),(const void*)""))==0;
  if (i2) goto l45;
