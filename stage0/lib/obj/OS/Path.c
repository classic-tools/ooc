...
l32:
  *(OOC_UINT8*)((OOC_INT32)dirname+(_check_index(i0, dirname_0d, OOC_UINT16, 1606))) = (OOC_CHAR8)'\000';
  i0 = *(OOC_UINT8*)((OOC_INT32)dirname+(_check_index((OOC_INT32)0, dirname_0d, OOC_UINT16, 1768)));
  i0 = i0!=(OOC_CHAR8)'\000';
  if (i0) goto l35;
  i0=-1;
  goto l45;
...
l25:
  ...
  goto l29;
l28:
  Strings__Extract((void*)(OOC_INT32)path, path_0d, (OOC_INT32)0, i0, (void*)(OOC_INT32)root, root_0d);
