...
static void IO_Buffer__Init(IO_Buffer__Channel ch, IO__ByteChannel base) {
  ...
  *(OOC_UINT8*)((_check_pointer(i0, 1483))+12) = OOC_TRUE;
...
l11:
  i1 = (OOC_INT32)ch;
  i2 = *(OOC_INT32*)((_check_pointer(i1, 3247))+16);
  i3 = *(OOC_INT32*)((_check_pointer(i1, 3256))+20);
  _assert((i2==i3), 127, 3238);
  i2 = i0>=4096;
  if (i2) goto l22;
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3591))+8);
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3591))+8);
  i2 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 3596)))), IO__ByteChannelDesc_Read)),IO__ByteChannelDesc_Read)((IO__ByteChannel)i3, (void*)((_check_pointer(i1, 3604))+24), 8192, 0, 8192);
  d = i2;
  *(OOC_UINT8*)((_check_pointer(i1, 3639))+12) = OOC_TRUE;
  *(OOC_INT32*)((_check_pointer(i1, 3667))+16) = 0;
  i3 = i2<0;
  if (i3) goto l16;
  *(OOC_INT32*)((_check_pointer(i1, 3953))+20) = i2;
  i2 = start;
  i0 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 3993)))), IO_Buffer__ChannelDesc_Read)),IO_Buffer__ChannelDesc_Read)((IO_Buffer__Channel)i1, (void*)(OOC_INT32)buffer, -1, i2, i0);
  i1 = i;
  return (i1+i0);
  goto l32;
l16:
  i0 = i;
  i2 = i0>0;
  *(OOC_INT32*)((_check_pointer(i1, 3749))+20) = 0;
  if (i2) goto l19;
  return -1;
  goto l32;
l19:
  ...
  goto l32;
l22:
  i2 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3323))+8);
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3323))+8);
  i3 = start;
  i0 = OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 3328)))), IO__ByteChannelDesc_Read)),IO__ByteChannelDesc_Read)((IO__ByteChannel)i1, (void*)(OOC_INT32)buffer, -1, i3, i0);
  i1 = i0<0;
  if (i1) goto l25;
  i1 = i;
  return (i0+i1);
...
OOC_INT32 IO_Buffer__ChannelDesc_Write(IO_Buffer__Channel ch, const OOC_CHAR8 buffer[], OOC_LEN buffer_0d, OOC_INT32 start, OOC_INT32 length) {
  ...
  *(OOC_UINT8*)((_check_pointer(i0, 4302))+12) = OOC_FALSE;
l3:
