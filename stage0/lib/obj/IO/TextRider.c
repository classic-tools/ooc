...
void IO_TextRider__InitWriter(IO_TextRider__Writer w, IO__ByteChannel ch) {
  ...
  *(OOC_INT32*)((_check_pointer(i0, 2144))+4) = (OOC_INT32)0;
...
l5:
  ...
  i2=(OOC_INT32)0;
l9_loop:
  i4 = *(OOC_UINT8*)((OOC_INT32)marker+(_check_index(i2, marker_0d, OOC_UINT16, 3337)));
  *(OOC_UINT8*)(((_check_pointer(i3, 3319))+8)+(_check_index(i2, 2, OOC_UINT16, 3324))) = i4;
  i2 = i2+1;
  i4 = i2<=i1;
  i = i2;
  if (i4) goto l9_loop;
l14:
  *(OOC_INT16*)((_check_pointer(i3, 3359))+10) = i0;
l15:
  return;
  ;
}
...
static void IO_TextRider__WritePad(IO_TextRider__Writer w, OOC_INT32 n) {
  ...
  i0 = (OOC_INT32)w;
l3_loop:
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 5179)))), IO_TextRider__WriterDesc_WriteChar)),IO_TextRider__WriterDesc_WriteChar)((IO_TextRider__Writer)i0, (OOC_CHAR8)' ');
  i1 = n;
  i1 = i1-1;
  n = i1;
  i1 = i1>0;
...
l3_loop:
      if (i0) goto l6;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 6429)))), IO_TextRider__WriterDesc_WriteChar)),IO_TextRider__WriterDesc_WriteChar)((IO_TextRider__Writer)i1, (OOC_CHAR8)'0');
      goto l7;
l6:
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i1, 6407)))), IO_TextRider__WriterDesc_WriteChar)),IO_TextRider__WriterDesc_WriteChar)((IO_TextRider__Writer)i1, (OOC_CHAR8)'F');
l7:
      i2 = digits;
      i2 = i2-1;
      digits = i2;
...
l15_loop:
      ...
      i4 = i3<=9;
      if (i4) goto l18;
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 6678)))), IO_TextRider__WriterDesc_WriteChar)),IO_TextRider__WriterDesc_WriteChar)((IO_TextRider__Writer)i0, (55+i3));
      goto l19;
l18:
      OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 6631)))), IO_TextRider__WriterDesc_WriteChar)),IO_TextRider__WriterDesc_WriteChar)((IO_TextRider__Writer)i0, (48+i3));
l19:
      i2 = i2>0;
      if (i2) goto l15_loop;
l24:
...
l4:
  i0 = (OOC_INT32)w;
  i1 = d;
  IO_TextRider__WriterDesc_WriteHex_WriteHexDigits((IO_TextRider__Writer)i0, (void*)(OOC_INT32)&lint, i1);
  return;
  ;
}
...
void IO_TextRider__WriterDesc_WriteSet(IO_TextRider__Writer w, OOC_UINT32 s) {
  ...
  i0 = (OOC_INT32)w;
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 9473)))), IO_TextRider__WriterDesc_WriteChar)),IO_TextRider__WriterDesc_WriteChar)((IO_TextRider__Writer)i0, (OOC_CHAR8)'{');
  bit = 0;
  addComma = OOC_FALSE;
  i1 = s;
  i2=0;i3=OOC_FALSE;
...
l29:
  ...
  goto l1_loop;
l33:
  OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i0, 9941)))), IO_TextRider__WriterDesc_WriteChar)),IO_TextRider__WriterDesc_WriteChar)((IO_TextRider__Writer)i0, (OOC_CHAR8)'}');
  return;
  ;
}
