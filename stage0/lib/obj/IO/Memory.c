...
OOC_INT32 IO_Memory__ChannelDesc_Write(IO_Memory__Channel ch, const OOC_CHAR8 buffer[], OOC_LEN buffer_0d, OOC_INT32 start, OOC_INT32 length) {
  ...
  i3 = length;
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 2669)), 0);
  i1 = (i2+i3)>i1;
  if (!i1) goto l9;
  i1 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 2695))+16);
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 2700)), 0);
...
l8:
  ...
  i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 2860)), 0);
...
l8_loop:
  ...
  i5 = *(OOC_UINT8*)(i5+(_check_index(i0, i6, OOC_UINT32, 3979)));
