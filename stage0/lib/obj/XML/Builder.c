...
XML_Builder__Attribute XML_Builder__NewAttribute(XML_DTD__NamespaceDeclaration namespaceDecl, XML_UnicodeBuffer__CharArray localName, XML_DTD__AttrDecl attrDecl, XML_DTD__AttValue value, OOC_CHAR8 specified, XML_Locator__Locator locator) {
  ...
  i0 = specified;
  i1 = !i0;
  i2 = (OOC_INT32)RT0__NewObject(_td_XML_Builder__Attribute.baseTypes[0]);
  if (!i1) goto l4;
...
l4:
  ...
  XML_Builder__InitAttribute((XML_Builder__Attribute)i2, (XML_DTD__NamespaceDeclaration)i1, (XML_UnicodeBuffer__CharArray)i3, (XML_DTD__AttrDecl)i4, (XML_DTD__AttValue)i5, i0, (XML_Locator__Locator)i6);
  return (XML_Builder__Attribute)i2;
  ;
}
...
l3_loop:
  ...
  *(OOC_INT32*)(i3+(_check_index(i2, i4, OOC_UINT32, 17335))*4) = (OOC_INT32)0;
  i2 = i2+1;
  i3 = i2<=i1;
  i = i2;
  if (i3) goto l3_loop;
...
void XML_Builder__AttributeListDesc_Append(XML_Builder__AttributeList attrList, XML_Builder__Attribute attr) {
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 17609)), (OOC_INT32)0);
  i1 = i2==i1;
  if (!i1) goto l11;
