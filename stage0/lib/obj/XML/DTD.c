...
l9:
          ...
          i5 = OOC_ARRAY_LENGTH(i4, 0);
          i6 = pos;
          *(OOC_UINT16*)(i4+(_check_index(i6, i5, OOC_UINT32, 20188))*2) = (OOC_CHAR16)' ';
          pos = (i6+1);
          skipSpace = i3;
l11:
          i0 = i0+1;
...
l11:
  ...
  i3 = pos;
  *(OOC_UINT16*)(i0+(_check_index(i3, i2, OOC_UINT32, 21382))*2) = (OOC_CHAR16)0;
...
l8:
  ...
  *(OOC_UINT16*)(i1+(_check_index(i0, i3, OOC_UINT32, 36369))*2) = (OOC_CHAR16)0;
...
void XML_DTD__Init(XML_DTD__Builder b) {
  ...
  auto void XML_DTD__Init_PredefEntity(const OOC_CHAR16 name__ref[], OOC_LEN name_0d, const OOC_CHAR16 replacement__ref[], OOC_LEN replacement_0d);
    ...
    void XML_DTD__Init_PredefEntity(const OOC_CHAR16 name__ref[], OOC_LEN name_0d, const OOC_CHAR16 replacement__ref[], OOC_LEN replacement_0d) {
      ...
      _copy_16((OOC_INT32)name,(_check_pointer(i0, 37287)),i1);
      ...
      _copy_16((OOC_INT32)replacement,(_check_pointer(i1, 37386)),i2);
