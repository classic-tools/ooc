...
void XML_DTD__InitDeclaration(XML_DTD__Declaration decl, XML_UnicodeBuffer__CharArray name) {
  ...
  i0 = (OOC_INT32)decl;
  *(OOC_INT32*)(_check_pointer(i0, 15157)) = (OOC_INT32)0;
  i1 = (OOC_INT32)name;
...
static void XML_DTD__InitNamespace(XML_DTD__Namespace ns) {
  ...
  i0 = (OOC_INT32)ns;
  *(OOC_INT32*)(_check_pointer(i0, 15275)) = (OOC_INT32)0;
  return;
  ;
}
...
OOC_CHAR8 XML_DTD__NamespaceDesc_Add(XML_DTD__Namespace ns, XML_DTD__Declaration decl) {
  ...
  auto OOC_CHAR8 XML_DTD__NamespaceDesc_Add_RecAdd(XML_DTD__Declaration *list);
    ...
    OOC_CHAR8 XML_DTD__NamespaceDesc_Add_RecAdd(XML_DTD__Declaration *list) {
      ...
      i1 = (
      _cmp16((const void*)(_check_pointer(i1, 15974)),(const void*)(_check_pointer(i2, 15988))))!=(OOC_INT32)0;
      if (i1) goto l5;
      return OOC_FALSE;
      goto l8;
l5:
...
l8:
  ...
  i0 = (OOC_INT32)decl;
  *(OOC_INT32*)(_check_pointer(i0, 16108)) = (OOC_INT32)0;
  i0 = (OOC_INT32)ns;
...
l3:
  ...
  i2 = (OOC_INT32)name;
  i1 = (
  _cmp16((const void*)(_check_pointer(i1, 16323)),(const void*)(_check_pointer(i2, 16331))))!=(OOC_INT32)0;
...
l11:
  ...
  i2 = (
  _cmp16((const void*)(_check_pointer(i2, 16323)),(const void*)(_check_pointer(i1, 16331))))!=(OOC_INT32)0;
...
void XML_DTD__InitFragment(XML_DTD__Fragment f) {
  ...
  i0 = (OOC_INT32)f;
  *(OOC_INT32*)(_check_pointer(i0, 16548)) = (OOC_INT32)0;
  return;
  ;
}
...
l3:
  ...
  i6=0;
l6_loop:
  i7 = _check_pointer(i3, 17196);
  i8 = OOC_ARRAY_LENGTH(i7, (OOC_INT32)0);
  i9 = _check_pointer(i5, 17209);
  i10 = OOC_ARRAY_LENGTH(i9, (OOC_INT32)0);
  i9 = *(OOC_UINT16*)(i9+(_check_index((i1+i6), i10, OOC_UINT32, 17209))*2);
  *(OOC_UINT16*)(i7+(_check_index(i6, i8, OOC_UINT32, 17196))*2) = i9;
  i6 = i6+1;
  i7 = i6<=i4;
  i = i6;
  if (i7) goto l6_loop;
...
void XML_DTD__InitAttValue(XML_DTD__AttValue attValue) {
  ...
  *(OOC_INT32*)(_check_pointer(i0, 17889)) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i0, 17924))+4) = (OOC_INT32)0;
  return;
  ;
}
...
void XML_DTD__AttValueDesc_Clear(XML_DTD__AttValue attValue) {
  ...
  i0 = (OOC_INT32)attValue;
  *(OOC_INT32*)(_check_pointer(i0, 18204)) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i0, 18239))+4) = (OOC_INT32)0;
  return;
  ;
}
...
void XML_DTD__AttValueDesc_Append(XML_DTD__AttValue attValue, XML_DTD__Fragment fragment) {
  ...
  *(OOC_INT32*)(_check_pointer(i0, 18356)) = (OOC_INT32)0;
...
l11:
  ...
  i3 = OOC_ARRAY_LENGTH((_check_pointer(i3, 19051)), (OOC_INT32)0);
...
l6:
          ...
          i4 = !i4;
          if (i4) goto l9;
          *didNormalization = OOC_TRUE;
          goto l11;
l9:
          i4 = _check_pointer(i2, 20188);
          i5 = OOC_ARRAY_LENGTH(i4, (OOC_INT32)0);
          i6 = pos;
          *(OOC_UINT16*)(i4+(_check_index(i6, i5, OOC_UINT32, 20188))*2) = (OOC_CHAR8)' ';
          pos = (i6+1);
          skipSpace = i3;
l11:
          i0 = i0+1;
...
l8:
      ...
      i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 20896)), (OOC_INT32)0);
...
l10:
      ...
      i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 20796)), (OOC_INT32)0);
      i0 = LongStrings__Length((void*)(_check_pointer(i3, 20796)), i0);
      i2 = OOC_ARRAY_LENGTH((_check_pointer(i2, 20763)), (OOC_INT32)0);
...
l20:
  ...
  skipSpace = i1;
  *didNormalization = OOC_FALSE;
  XML_DTD__AttValueDesc_FlattenValue_Append((XML_DTD__AttValue)i0);
  i0 = normalizeWhitespace;
  if (i0) goto l3;
  i0=OOC_FALSE;
  goto l4;
l3:
...
l4:
  ...
  goto l9;
l7:
  i0 = _check_pointer(i1, 21304);
  i2 = pos;
  i3 = OOC_ARRAY_LENGTH(i0, (OOC_INT32)0);
  i0 = *(OOC_UINT16*)(i0+(_check_index((i2-1), i3, OOC_UINT32, 21304))*2);
  i0 = i0==(OOC_CHAR8)' ';
...
l9:
  ...
  *didNormalization = OOC_TRUE;
l11:
  i0 = _check_pointer(i1, 21382);
  i2 = OOC_ARRAY_LENGTH(i0, (OOC_INT32)0);
  i3 = pos;
  *(OOC_UINT16*)(i0+(_check_index(i3, i2, OOC_UINT32, 21382))*2) = (OOC_CHAR8)'\000';
...
XML_UnicodeBuffer__CharArray XML_DTD__AttValueDesc_Flatten(XML_DTD__AttValue attValue, XML_DTD__AttrDecl attrDecl) {
  ...
  i2 = i1!=(OOC_INT32)0;
  i3 = _check_pointer(i0, 21873);
  if (i2) goto l3;
  i1=OOC_FALSE;
  goto l4;
l3:
  i1 = *(OOC_INT8*)((_check_pointer(i1, 21952))+12);
  i1 = i1!=9;
  
l4:
  i0 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG(i3)), XML_DTD__AttValueDesc_FlattenValue)),XML_DTD__AttValueDesc_FlattenValue)((XML_DTD__AttValue)i0, i1, (void*)(OOC_INT32)&didNormalization);
...
XML_UnicodeBuffer__CharArray XML_DTD__AttValueDesc_FlattenNorm(XML_DTD__AttValue attValue, XML_DTD__AttrDecl attrDecl, OOC_CHAR8 *didNormalization) {
  ...
  i1 = (OOC_INT32)attrDecl;
  i2 = i1!=(OOC_INT32)0;
  i3 = _check_pointer(i0, 22426);
  if (i2) goto l3;
  i1=OOC_FALSE;
  goto l4;
l3:
  i1 = *(OOC_INT8*)((_check_pointer(i1, 22505))+12);
  i1 = i1!=9;
...
XML_DTD__Enumeration XML_DTD__BuilderDesc_NewEnumeration(XML_DTD__Builder b) {
  ...
  *(OOC_INT32*)(_check_pointer(i0, 22822)) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i0, 22849))+4) = (OOC_INT32)0;
...
void XML_DTD__EnumerationDesc_Append(XML_DTD__Enumeration _enum, XML_UnicodeBuffer__CharArray name) {
  ...
  *(OOC_INT32*)(_check_pointer(i0, 23019)) = (OOC_INT32)0;
  i1 = (OOC_INT32)name;
...
l3:
  ...
  i1 = (
  _cmp16((const void*)(_check_pointer(i1, 23498)),(const void*)(OOC_INT32)name))!=(OOC_INT32)0;
...
void XML_DTD__BuilderDesc_AddAttribute(XML_DTD__Builder b, XML_DTD__AttrDecl attrDecl) {
  ...
  *(OOC_INT32*)(_check_pointer(i1, 24803)) = i2;
  goto l4;
l3:
  *(OOC_INT32*)((_check_pointer(i0, 24744))+16) = i2;
l4:
  *(OOC_INT32*)((_check_pointer(i0, 24836))+20) = i2;
  return;
  ;
}
...
static void XML_DTD__InitEntity(XML_DTD__Entity ent, XML_UnicodeBuffer__CharArray name, OOC_INT8 type, XML_UnicodeBuffer__CharArray entityValue, OOC_CHAR8 externalMarkupDecl) {
  ...
  *(OOC_UINT8*)((_check_pointer(i1, 26494))+17) = OOC_FALSE;
...
OOC_INT32 XML_DTD__EntityDesc_LengthValue(XML_DTD__Entity entity) {
  ...
  i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 26840)), (OOC_INT32)0);
  return (i0-2);
  ;
}
...
OOC_CHAR8 XML_DTD__BuilderDesc_IsValidEntityDecl(XML_DTD__Builder b, XML_UnicodeBuffer__CharArray name, XML_UnicodeBuffer__CharArray entityValue) {
  ...
  i0 = (OOC_INT32)name;
  i1 = (
  _cmp16((const void*)(_check_pointer(i0, 28068)),(const void*)((OOC_CHAR16[]){108,116,0})))==(OOC_INT32)0;
  if (i1) goto l31;
  i1 = (
  _cmp16((const void*)(_check_pointer(i0, 28136)),(const void*)((OOC_CHAR16[]){97,109,112,0})))==(OOC_INT32)0;
  if (i1) goto l29;
  i1 = (
  _cmp16((const void*)(_check_pointer(i0, 28205)),(const void*)((OOC_CHAR16[]){103,116,0})))==(OOC_INT32)0;
  if (i1) goto l23;
  i1 = (
  _cmp16((const void*)(_check_pointer(i0, 28297)),(const void*)((OOC_CHAR16[]){97,112,111,115,0})))==(OOC_INT32)0;
  if (i1) goto l17;
  i0 = (
  _cmp16((const void*)(_check_pointer(i0, 28391)),(const void*)((OOC_CHAR16[]){113,117,111,116,0})))==(OOC_INT32)0;
  if (i0) goto l11;
  return OOC_TRUE;
  goto l32;
l11:
  i0 = (OOC_INT32)entityValue;
  i1 = (
  _cmp16((const void*)(_check_pointer(i0, 28433)),(const void*)((OOC_CHAR16[]){34,0})))==(OOC_INT32)0;
  if (i1) goto l14;
  i0 = (
  _cmp16((const void*)(_check_pointer(i0, 28457)),(const void*)((OOC_CHAR16[]){38,35,51,52,59,0})))==(OOC_INT32)0;
...
l17:
  i0 = (OOC_INT32)entityValue;
  i1 = (
  _cmp16((const void*)(_check_pointer(i0, 28339)),(const void*)((OOC_CHAR16[]){39,0})))==(OOC_INT32)0;
  if (i1) goto l20;
  i0 = (
  _cmp16((const void*)(_check_pointer(i0, 28363)),(const void*)((OOC_CHAR16[]){38,35,51,57,59,0})))==(OOC_INT32)0;
...
l23:
  i0 = (OOC_INT32)entityValue;
  i1 = (
  _cmp16((const void*)(_check_pointer(i0, 28245)),(const void*)((OOC_CHAR16[]){62,0})))==(OOC_INT32)0;
  if (i1) goto l26;
  i0 = (
  _cmp16((const void*)(_check_pointer(i0, 28269)),(const void*)((OOC_CHAR16[]){38,35,54,50,59,0})))==(OOC_INT32)0;
...
l29:
  i0 = (OOC_INT32)entityValue;
  return ((
  _cmp16((const void*)(_check_pointer(i0, 28177)),(const void*)((OOC_CHAR16[]){38,35,51,56,59,0})))==(OOC_INT32)0);
  goto l32;
l31:
  i0 = (OOC_INT32)entityValue;
  return ((
  _cmp16((const void*)(_check_pointer(i0, 28108)),(const void*)((OOC_CHAR16[]){38,35,54,48,59,0})))==(OOC_INT32)0);
l32:
...
static void XML_DTD__InitExternalEntity(XML_DTD__ExternalEntity ent, XML_UnicodeBuffer__CharArray name, OOC_INT8 type, XML_UnicodeBuffer__CharArray _public, XML_UnicodeBuffer__CharArray system, XML_UnicodeBuffer__CharArray ndata, URI__URI baseURI, OOC_CHAR8 externalMarkupDecl) {
  ...
  i0 = (OOC_INT32)name;
  i1 = type;
  i2 = externalMarkupDecl;
  i3 = (OOC_INT32)ent;
  XML_DTD__InitEntity((XML_DTD__Entity)i3, (XML_UnicodeBuffer__CharArray)i0, i1, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, i2);
...
XML_DTD__ExternalEntity XML_DTD__BuilderDesc_NewExternalDTD(XML_DTD__Builder b, XML_UnicodeBuffer__CharArray _public, XML_UnicodeBuffer__CharArray system, URI__URI baseURI) {
  ...
  XML_DTD__InitExternalEntity((XML_DTD__ExternalEntity)i0, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, 6, (XML_UnicodeBuffer__CharArray)i1, (XML_UnicodeBuffer__CharArray)i2, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, (URI__URI)i3, OOC_FALSE);
  return (XML_DTD__ExternalEntity)i0;
  ;
}
...
XML_DTD__ExternalEntity XML_DTD__BuilderDesc_NewDocumentEntity(XML_DTD__Builder b, URI__URI baseURI) {
  ...
  XML_DTD__InitExternalEntity((XML_DTD__ExternalEntity)i0, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, 5, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, (URI__URI)i1, OOC_FALSE);
...
static void XML_DTD__InitCP(XML_DTD__CP cp, OOC_INT8 cpMode) {
  ...
  *(OOC_INT32*)((_check_pointer(i0, 31826))+4) = (OOC_INT32)0;
  return;
  ;
}
...
l10:
  ...
  i0 = (
  _cmp16((const void*)(_check_pointer(i0, 33943)),(const void*)((OOC_CHAR16[]){35,80,67,68,65,84,65,0})))==(OOC_INT32)0;
...
l17:
  ...
  i2 = (
  _cmp16((const void*)(_check_pointer(i2, 33530)),(const void*)((OOC_CHAR16[]){69,77,80,84,89,0})))==(OOC_INT32)0;
  if (i2) goto l24;
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 33623))+8);
  i0 = (
  _cmp16((const void*)(_check_pointer(i0, 33629)),(const void*)((OOC_CHAR16[]){65,78,89,0})))==(OOC_INT32)0;
  if (i0) goto l22;
...
l27:
  ...
  *(OOC_UINT8*)((_check_pointer(i1, 34234))+18) = OOC_FALSE;
...
void XML_DTD__ElementDeclDesc_SetMultipleDecl(XML_DTD__ElementDecl elemDecl) {
  ...
  i0 = (OOC_INT32)elemDecl;
  *(OOC_UINT8*)((_check_pointer(i0, 34896))+18) = OOC_TRUE;
  return;
  ;
}
...
XML_UnicodeBuffer__CharArray XML_DTD__GetString(OOC_CHAR16 string[], OOC_LEN string_0d, OOC_INT32 start, OOC_INT32 end) {
  ...
  i4=0;
l3_loop:
  i5 = _check_pointer(i2, 36332);
  i6 = OOC_ARRAY_LENGTH(i5, (OOC_INT32)0);
  i7 = *(OOC_UINT16*)((OOC_INT32)string+(_check_index((i1+i4), string_0d, OOC_UINT32, 36345))*2);
  *(OOC_UINT16*)(i5+(_check_index(i4, i6, OOC_UINT32, 36332))*2) = i7;
  i4 = i4+1;
  i5 = i4<=i3;
  i = i4;
  if (i5) goto l3_loop;
l8:
  ...
  *(OOC_UINT16*)(i1+(_check_index(i0, i3, OOC_UINT32, 36369))*2) = (OOC_CHAR8)'\000';
...
XML_DTD__StringURI XML_DTD__GetStringURI(OOC_CHAR8 string[], OOC_LEN string_0d, OOC_INT32 start, OOC_INT32 end) {
  ...
  i4=0;
l3_loop:
  i5 = _check_pointer(i2, 36770);
  i6 = OOC_ARRAY_LENGTH(i5, (OOC_INT32)0);
  i7 = *(OOC_UINT8*)((OOC_INT32)string+(_check_index((i1+i4), string_0d, OOC_UINT32, 36783)));
  *(OOC_UINT8*)(i5+(_check_index(i4, i6, OOC_UINT32, 36770))) = i7;
  i4 = i4+1;
  i5 = i4<=i3;
  i = i4;
  if (i5) goto l3_loop;
l8:
  ...
  i3 = OOC_ARRAY_LENGTH(i1, (OOC_INT32)0);
  *(OOC_UINT8*)(i1+(_check_index(i0, i3, OOC_UINT32, 36807))) = (OOC_CHAR8)'\000';
...
void XML_DTD__Init(XML_DTD__Builder b) {
  ...
  auto void XML_DTD__Init_PredefEntity(const OOC_CHAR16 name__ref[], OOC_LEN name_0d, const OOC_CHAR16 replacement__ref[], OOC_LEN replacement_0d);
    ...
    void XML_DTD__Init_PredefEntity(const OOC_CHAR16 name__ref[], OOC_LEN name_0d, const OOC_CHAR16 replacement__ref[], OOC_LEN replacement_0d) {
      ...
      i1 = OOC_ARRAY_LENGTH((_check_pointer(i0, 37287)), (OOC_INT32)0);
      ...
      i2 = OOC_ARRAY_LENGTH((_check_pointer(i1, 37386)), (OOC_INT32)0);
      _copy_16((const void*)(OOC_INT32)replacement,(void*)(_check_pointer(i1, 37386)),i2);
      i2 = _check_pointer(i1, 37406);
      i3 = OOC_ARRAY_LENGTH((_check_pointer(i1, 37422)), (OOC_INT32)0);
      i4 = OOC_ARRAY_LENGTH(i2, (OOC_INT32)0);
      *(OOC_UINT16*)(i2+(_check_index((i3-2), i4, OOC_UINT32, 37406))*2) = (OOC_CHAR16)65535;
      i2 = (OOC_INT32)b;
      i0 = (OOC_INT32)OOC_TBCALL(((OOC_INT32)OOC_TBPROC_ADR(((OOC_INT32)OOC_TYPE_TAG((_check_pointer(i2, 37480)))), XML_DTD__BuilderDesc_NewInternalEntity)),XML_DTD__BuilderDesc_NewInternalEntity)((XML_DTD__Builder)i2, (XML_UnicodeBuffer__CharArray)i0, 0, (XML_UnicodeBuffer__CharArray)i1, OOC_FALSE);
  ...
  i0 = (OOC_INT32)b;
  *(OOC_INT32*)(_check_pointer(i0, 37677)) = (OOC_INT32)0;
  i1 = (OOC_INT32)XML_DTD__NewNamespace();
  ...
  *(OOC_INT32*)((_check_pointer(i0, 37825))+16) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i0, 37854))+20) = (OOC_INT32)0;
...
void OOC_XML_DTD_init(void) {
  ...
  XML_DTD__InitAttrDecl((XML_DTD__AttrDecl)i0, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, (XML_UnicodeBuffer__CharArray)(OOC_INT32)0, -1, (XML_DTD__Enumeration)(OOC_INT32)0, -1, (XML_DTD__AttValue)(OOC_INT32)0, OOC_FALSE);
  return;
  ;
}
