...
RT0__StructDesc _td_XML_UnicodeBuffer__262 = { (RT0__Struct[]){&RT0__longchar}, NULL, &_mid, NULL, 2, 1, RT0__strOpenArray };
RT0__StructDesc _td_XML_UnicodeBuffer__CharArray = { (RT0__Struct[]){&_td_XML_UnicodeBuffer__262}, NULL, &_mid, "CharArray", 4, -1, RT0__strPointer };
...
RT0__StructDesc _td_XML_UnicodeBuffer__OutputDesc = { (RT0__Struct[]){&_td_XML_UnicodeBuffer__OutputDesc}, (void*[]){(void*)XML_UnicodeBuffer__OutputDesc_Flush,(void*)XML_UnicodeBuffer__OutputDesc_Write16,(void*)XML_UnicodeBuffer__OutputDesc_Write16I,(void*)XML_UnicodeBuffer__OutputDesc_Write8,(void*)XML_UnicodeBuffer__OutputDesc_Write8I}, &_mid, "OutputDesc", 32, 0, RT0__strRecord };
RT0__StructDesc _td_XML_UnicodeBuffer__3628 = { (RT0__Struct[]){&RT0__char}, NULL, &_mid, NULL, 8192, 8192, RT0__strArray };
RT0__StructDesc _td_XML_UnicodeBuffer__3617 = { (RT0__Struct[]){&_td_XML_UnicodeBuffer__3628}, NULL, &_mid, NULL, 4, -1, RT0__strPointer };
RT0__StructDesc _td_XML_UnicodeBuffer__3727 = { (RT0__Struct[]){&RT0__longchar}, NULL, &_mid, NULL, 16384, 8192, RT0__strArray };
RT0__StructDesc _td_XML_UnicodeBuffer__3716 = { (RT0__Struct[]){&_td_XML_UnicodeBuffer__3727}, NULL, &_mid, NULL, 4, -1, RT0__strPointer };
RT0__StructDesc _td_XML_UnicodeBuffer__3852 = { (RT0__Struct[]){&RT0__char}, NULL, &_mid, NULL, 1, 1, RT0__strOpenArray };
RT0__StructDesc _td_XML_UnicodeBuffer__4822 = { (RT0__Struct[]){&RT0__char}, NULL, &_mid, NULL, 16, 16, RT0__strArray };
RT0__StructDesc _td_XML_UnicodeBuffer__11645 = { (RT0__Struct[]){&RT0__char}, NULL, &_mid, NULL, 256, 256, RT0__strArray };
RT0__StructDesc _td_XML_UnicodeBuffer__14989 = { (RT0__Struct[]){&RT0__longchar}, NULL, &_mid, NULL, 2, 1, RT0__strOpenArray };
RT0__StructDesc _td_XML_UnicodeBuffer__15809 = { (RT0__Struct[]){&RT0__char}, NULL, &_mid, NULL, 1, 1, RT0__strOpenArray };
RT0__StructDesc _td_XML_UnicodeBuffer__16624 = { (RT0__Struct[]){&RT0__longchar}, NULL, &_mid, NULL, 2, 1, RT0__strOpenArray };
RT0__StructDesc _td_XML_UnicodeBuffer__16764 = { (RT0__Struct[]){&RT0__char}, NULL, &_mid, NULL, 1, 1, RT0__strOpenArray };
