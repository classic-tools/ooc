...
static void ADT_Object_Storage__InitReader(ADT_Object_Storage__Reader r, IO__ByteChannel ch) {
  ...
  *(OOC_INT32*)((_check_pointer(i1, 3241))+12) = ((OOC_INT32)RT0__NewObject(_td_ADT_Object_Storage__ObjectArray.baseTypes[0], 124));
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3273))+12);
  i0 = _check_pointer(i0, 3281);
  i2 = OOC_ARRAY_LENGTH(i0, (OOC_INT32)0);
  *(OOC_INT32*)(i0+(_check_index(0, i2, OOC_UINT8, 3281))*4) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i1, 3298))+8) = 1;
  *(OOC_INT32*)((_check_pointer(i1, 3327))+20) = ((OOC_INT32)RT0__NewObject(_td_ADT_Object_Storage__TypeArray.baseTypes[0], 12));
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3359))+20);
  i0 = _check_pointer(i0, 3368);
  i2 = OOC_ARRAY_LENGTH(i0, (OOC_INT32)0);
  *(OOC_INT32*)(i0+((_check_index(0, i2, OOC_UINT8, 3368))*12)) = (OOC_INT32)0;
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3391))+20);
  i0 = _check_pointer(i0, 3400);
  i2 = OOC_ARRAY_LENGTH(i0, (OOC_INT32)0);
  *(OOC_INT32*)((i0+((_check_index(0, i2, OOC_UINT8, 3400))*12))+4) = (OOC_INT32)0;
  i0 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i1, 3429))+20);
  i0 = _check_pointer(i0, 3438);
  i2 = OOC_ARRAY_LENGTH(i0, (OOC_INT32)0);
  *(OOC_INT32*)((i0+((_check_index(0, i2, OOC_UINT8, 3438))*12))+8) = (OOC_INT32)0;
  *(OOC_INT32*)((_check_pointer(i1, 3465))+16) = 1;
  return;
  ;
}
...
static void ADT_Object_Storage__InitWriter(ADT_Object_Storage__Writer w, IO__ByteChannel ch) {
  ...
  *(OOC_INT32*)((_check_pointer(i1, 3604))+8) = 0;
  *(OOC_INT32*)((_check_pointer(i1, 3633))+12) = ((OOC_INT32)RT0__NewObject(_td_ADT_Object_Storage__TypeRefMap.baseTypes[0], 12));
  *(OOC_INT32*)((_check_pointer(i1, 3668))+16) = 0;
  i0 = (OOC_INT32)ADT_Dictionary_AddressKey_IntValue__New();
  *(OOC_INT32*)((_check_pointer(i1, 3693))+20) = i0;
  return;
  ;
}
...
l5:
      ...
      i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 5459)), (OOC_INT32)0);
      i2 = tref;
      i1 = i2==i1;
      if (!i1) goto l8;
...
l38:
    ...
    void ADT_Object_Storage__ReaderDesc_ReadObject_ExtendObjTab(ADT_Object_Storage__ObjectArray *tab) {
      ...
      i0 = (OOC_INT32)*tab;
      i1 = OOC_ARRAY_LENGTH((_check_pointer(i0, 6684)), (OOC_INT32)0);
      ...
      i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 6730)), (OOC_INT32)0);
      i0 = i0-1;
      i2 = 0<=i0;
      i = 0;
      if (!i2) goto l8;
...
l7:
  ...
  *obj = (ADT_Storable__Object)((OOC_INT32)_type_cast_fast(OOC_PTR, OOC_PTR, i0));
  ...
  i0 = OOC_ARRAY_LENGTH((_check_pointer(i0, 7729)), (OOC_INT32)0);
  i2 = ref;
  i0 = i2==i0;
  if (!i0) goto l12;
...
void ADT_Object_Storage__ReaderDesc_Disconnect(ADT_Object_Storage__Reader r) {
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 8060)), (OOC_INT32)0);
  i1 = i1-1;
  i2 = 0<=i1;
  i = 0;
  if (!i2) goto l8;
...
l8:
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 8136)), (OOC_INT32)0);
  i1 = i1-1;
  i2 = 0<=i1;
  i = 0;
  if (!i2) goto l16;
...
l4_loop:
      ...
      i6 = (
      _cmp8((const void*)(_check_pointer(i6, 8969)),(const void*)(_check_pointer(i3, 8979))))<(OOC_INT32)0;
      if (i6) goto l11;
      ...
      i6 = (
      _cmp8((const void*)(_check_pointer(i6, 9021)),(const void*)(_check_pointer(i3, 9031))))==(OOC_INT32)0;
      if (i6) goto l9;
      i6=OOC_FALSE;
      goto l13;
l9:
      ...
      i6 = (
      _cmp8((const void*)(_check_pointer(i6, 9073)),(const void*)(_check_pointer(i2, 9082))))<=(OOC_INT32)0;
...
l21:
      ...
      i4 = (OOC_INT32)module;
      i3 = (
      _cmp8((const void*)(_check_pointer(i3, 9215)),(const void*)(_check_pointer(i4, 9225))))!=(OOC_INT32)0;
...
l26:
      ...
      i4 = (OOC_INT32)type;
      i3 = (
      _cmp8((const void*)(_check_pointer(i3, 9263)),(const void*)(_check_pointer(i4, 9271))))!=(OOC_INT32)0;
...
l32:
      ...
      i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 9391)), (OOC_INT32)0);
      i1 = i3==i1;
      if (!i1) goto l43;
...
void ADT_Object_Storage__WriterDesc_Disconnect(ADT_Object_Storage__Writer w) {
  ...
  i1 = OOC_ARRAY_LENGTH((_check_pointer(i1, 11003)), (OOC_INT32)0);
  i1 = i1-1;
  i2 = 0<=i1;
  i = 0;
  if (!i2) goto l8;
...
l3_loop:
  ...
  i4 = OOC_ARRAY_LENGTH(i3, (OOC_INT32)0);
  *(OOC_INT32*)(i3+((_check_index(i2, i4, OOC_UINT32, 11030))*12)) = (OOC_INT32)0;
  i3 = (OOC_INT32)*(OOC_INT32*)((_check_pointer(i0, 11057))+12);
  i3 = _check_pointer(i3, 11069);
  i4 = OOC_ARRAY_LENGTH(i3, (OOC_INT32)0);
  *(OOC_INT32*)((i3+((_check_index(i2, i4, OOC_UINT32, 11069))*12))+4) = (OOC_INT32)0;
  ...
  *(OOC_INT32*)((i3+((_check_index(i2, i4, OOC_UINT32, 11106))*12))+8) = 0;
  ...
  if (i3) goto l3_loop;
l8:
  *(OOC_INT32*)((_check_pointer(i0, 11134))+12) = (OOC_INT32)0;
  ...
  *(OOC_INT32*)((_check_pointer(i0, 11212))+20) = (OOC_INT32)0;
...
void OOC_ADT_Object_Storage_init(void) {
  _c0 = Object__NewLatin1Region("Type count mismatch", 20, (OOC_INT32)0, 19);
  _c1 = Object__NewLatin1Region("Invalid type reference", 23, (OOC_INT32)0, 22);
  _c2 = Object__NewLatin1Region("Object count mismatch", 22, (OOC_INT32)0, 21);
  _c3 = Object__NewLatin1Region("Failed to resolve type name", 28, (OOC_INT32)0, 27);
  _c4 = Object__NewLatin1Region("Invalid object reference", 25, (OOC_INT32)0, 24);
