...
RT0__StructDesc _td_ADT_Object_Storage__2078 = { (RT0__Struct[]){&_td_ADT_Object_Storage__2078}, (void*[]){}, &_mid, NULL, 12, 0, RT0__strRecord };
RT0__StructDesc _td_ADT_Object_Storage__2069 = { (RT0__Struct[]){&_td_ADT_Object_Storage__2078}, NULL, &_mid, NULL, 12, 1, RT0__strOpenArray };
RT0__StructDesc _td_ADT_Object_Storage__TypeRefMap = { (RT0__Struct[]){&_td_ADT_Object_Storage__2069}, NULL, &_mid, "TypeRefMap", 4, -1, RT0__strPointer };
RT0__StructDesc _td_ADT_Object_Storage__2179 = { (RT0__Struct[]){&_td_Object__Object}, NULL, &_mid, NULL, 4, 1, RT0__strOpenArray };
RT0__StructDesc _td_ADT_Object_Storage__ObjectArray = { (RT0__Struct[]){&_td_ADT_Object_Storage__2179}, NULL, &_mid, "ObjectArray", 4, -1, RT0__strPointer };
RT0__StructDesc _td_ADT_Object_Storage__2237 = { (RT0__Struct[]){&_td_ADT_Object_Storage__2237}, (void*[]){}, &_mid, NULL, 12, 0, RT0__strRecord };
RT0__StructDesc _td_ADT_Object_Storage__2228 = { (RT0__Struct[]){&_td_ADT_Object_Storage__2237}, NULL, &_mid, NULL, 12, 1, RT0__strOpenArray };
RT0__StructDesc _td_ADT_Object_Storage__TypeArray = { (RT0__Struct[]){&_td_ADT_Object_Storage__2228}, NULL, &_mid, "TypeArray", 4, -1, RT0__strPointer };
