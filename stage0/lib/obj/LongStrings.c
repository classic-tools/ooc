...
OOC_INT16 LongStrings__Length(const OOC_CHAR16 stringVal__ref[], OOC_LEN stringVal_0d) {
  ...
  i0 = *(OOC_UINT16*)((OOC_INT32)stringVal+(_check_index((OOC_INT32)0, stringVal_0d, OOC_UINT16, 2275))*2);
  i0 = i0!=(OOC_CHAR8)'\000';
  if (i0) goto l3;
  i0=(OOC_INT32)0;
  goto l9;
...
l6:
  if (!i2) goto l1_loop;
l9:
  *(OOC_UINT16*)((OOC_INT32)destination+(_check_index(i1, destination_0d, OOC_UINT16, 2797))*2) = (OOC_CHAR8)'\000';
  return;
  ;
}
...
l22:
  i0=i4;
l23:
  *(OOC_UINT16*)((OOC_INT32)destination+(_check_index(i0, destination_0d, OOC_UINT16, 4068))*2) = (OOC_CHAR8)'\000';
  return;
  ;
}
...
void LongStrings__Delete(OOC_CHAR16 stringVar[], OOC_LEN stringVar_0d, OOC_INT16 startPos, OOC_INT16 numberToDelete) {
  ...
  i0 = i1<i0;
  if (!i0) goto l15;
  *(OOC_UINT16*)((OOC_INT32)stringVar+(_check_index(i1, stringVar_0d, OOC_UINT16, 5023))*2) = (OOC_CHAR8)'\000';
  goto l15;
l6:
  i0 = i0-i2;
  i3 = i1<=i0;
...
l5:
  i0 = i3-i2;
  *(OOC_UINT16*)((OOC_INT32)destination+(_check_index(i3, destination_0d, OOC_UINT16, 6568))*2) = (OOC_CHAR8)'\000';
...
l7:
  ...
  if (!i4) goto l11;
  i0 = i3-i1;
  *(OOC_UINT16*)((OOC_INT32)destination+(_check_index(i0, destination_0d, OOC_UINT16, 6253))*2) = (OOC_CHAR8)'\000';
...
void LongStrings__Replace(const OOC_CHAR16 source__ref[], OOC_LEN source_0d, OOC_INT16 startPos, OOC_CHAR16 destination[], OOC_LEN destination_0d) {
  ...
  goto l7;
l5:
  i1 = *(OOC_UINT16*)((OOC_INT32)source+(_check_index((OOC_INT32)0, source_0d, OOC_UINT16, 7840))*2);
  i1 = i1!=(OOC_CHAR8)'\000';
...
void LongStrings__Append(const OOC_CHAR16 source__ref[], OOC_LEN source_0d, OOC_CHAR16 destination[], OOC_LEN destination_0d) {
  ...
  goto l5;
l3:
  i2 = *(OOC_UINT16*)((OOC_INT32)source+(_check_index((OOC_INT32)0, source_0d, OOC_UINT16, 8258))*2);
  i2 = i2!=(OOC_CHAR8)'\000';
...
l16:
  i0=i4;
l17:
  *(OOC_UINT16*)((OOC_INT32)destination+(_check_index(i0, destination_0d, OOC_UINT16, 8377))*2) = (OOC_CHAR8)'\000';
  return;
  ;
}
...
void LongStrings__Concat(const OOC_CHAR16 source1__ref[], OOC_LEN source1_0d, const OOC_CHAR16 source2__ref[], OOC_LEN source2_0d, OOC_CHAR16 destination[], OOC_LEN destination_0d) {
  ...
  i0 = *(OOC_UINT16*)((OOC_INT32)source1+(_check_index((OOC_INT32)0, source1_0d, OOC_UINT16, 8744))*2);
  i0 = i0!=(OOC_CHAR8)'\000';
  if (i0) goto l3;
  i0=OOC_FALSE;
  goto l5;
...
l16:
  i0=i1;
l17:
  i1 = *(OOC_UINT16*)((OOC_INT32)source2+(_check_index((OOC_INT32)0, source2_0d, OOC_UINT16, 8922))*2);
  i1 = i1!=(OOC_CHAR8)'\000';
  if (i1) goto l20;
  i1=OOC_FALSE;
  goto l22;
...
l30:
  if (i3) goto l25_loop;
l34:
  *(OOC_UINT16*)((OOC_INT32)destination+(_check_index(i0, destination_0d, OOC_UINT16, 9046))*2) = (OOC_CHAR8)'\000';
  return;
  ;
}
...
OOC_INT8 LongStrings__Compare(const OOC_CHAR16 stringVal1__ref[], OOC_LEN stringVal1_0d, const OOC_CHAR16 stringVal2__ref[], OOC_LEN stringVal2_0d) {
  ...
  i0 = *(OOC_UINT16*)((OOC_INT32)stringVal1+(_check_index((OOC_INT32)0, stringVal1_0d, OOC_UINT16, 13278))*2);
  i0 = i0!=(OOC_CHAR8)'\000';
  if (i0) goto l3;
  i0=OOC_FALSE;
  goto l5;
l3:
  i0 = *(OOC_UINT16*)((OOC_INT32)stringVal1+(_check_index((OOC_INT32)0, stringVal1_0d, OOC_UINT16, 13301))*2);
  i1 = *(OOC_UINT16*)((OOC_INT32)stringVal2+(_check_index((OOC_INT32)0, stringVal2_0d, OOC_UINT16, 13317))*2);
  i0 = i0==i1;
...
OOC_CHAR8 LongStrings__Equal(const OOC_CHAR16 stringVal1__ref[], OOC_LEN stringVal1_0d, const OOC_CHAR16 stringVal2__ref[], OOC_LEN stringVal2_0d) {
  ...
  OOC_INITIALIZE_VPAR(stringVal1__ref,stringVal1,OOC_CHAR16 ,(stringVal1_0d*2))
  OOC_INITIALIZE_VPAR(stringVal2__ref,stringVal2,OOC_CHAR16 ,(stringVal2_0d*2))
  i0 = *(OOC_UINT16*)((OOC_INT32)stringVal1+(_check_index((OOC_INT32)0, stringVal1_0d, OOC_UINT16, 13814))*2);
  i0 = i0!=(OOC_CHAR8)'\000';
  if (i0) goto l3;
  i0=OOC_FALSE;
  goto l5;
l3:
  i0 = *(OOC_UINT16*)((OOC_INT32)stringVal1+(_check_index((OOC_INT32)0, stringVal1_0d, OOC_UINT16, 13837))*2);
  i1 = *(OOC_UINT16*)((OOC_INT32)stringVal2+(_check_index((OOC_INT32)0, stringVal2_0d, OOC_UINT16, 13853))*2);
  i0 = i0==i1;
...
void LongStrings__FindDiff(const OOC_CHAR16 stringVal1__ref[], OOC_LEN stringVal1_0d, const OOC_CHAR16 stringVal2__ref[], OOC_LEN stringVal2_0d, OOC_CHAR8 *differenceFound, OOC_INT16 *posOfDifference) {
  ...
  OOC_INITIALIZE_VPAR(stringVal1__ref,stringVal1,OOC_CHAR16 ,(stringVal1_0d*2))
  OOC_INITIALIZE_VPAR(stringVal2__ref,stringVal2,OOC_CHAR16 ,(stringVal2_0d*2))
  i0 = *(OOC_UINT16*)((OOC_INT32)stringVal1+(_check_index((OOC_INT32)0, stringVal1_0d, OOC_UINT16, 18508))*2);
  i0 = i0!=(OOC_CHAR8)'\000';
  if (i0) goto l3;
  i0=OOC_FALSE;
  goto l5;
l3:
  i0 = *(OOC_UINT16*)((OOC_INT32)stringVal1+(_check_index((OOC_INT32)0, stringVal1_0d, OOC_UINT16, 18531))*2);
  i1 = *(OOC_UINT16*)((OOC_INT32)stringVal2+(_check_index((OOC_INT32)0, stringVal2_0d, OOC_UINT16, 18547))*2);
  i0 = i0==i1;
...
void LongStrings__Short(const OOC_CHAR16 source__ref[], OOC_LEN source_0d, OOC_CHAR8 repl, OOC_CHAR8 destination[], OOC_LEN destination_0d) {
  ...
  OOC_INITIALIZE_VPAR(source__ref,source,OOC_CHAR16 ,(source_0d*2))
  i0 = *(OOC_UINT16*)((OOC_INT32)source+(_check_index((OOC_INT32)0, source_0d, OOC_UINT16, 19846))*2);
  i0 = i0!=(OOC_CHAR8)'\000';
  i1 = destination_0d-1;
  if (i0) goto l3;
  i0=OOC_FALSE;
